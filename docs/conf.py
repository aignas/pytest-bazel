...
# -- Project information
project = "pytest-bazel"
copyright = "2024, Ignas Anikevicius"
author = "Ignas Anikevicius"

# NOTE: These are overriden by -D flags via --@rules_python//sphinxdocs:extra_defines
version = "0.0.0"
release = version
...
if os.environ.get("READTHEDOCS") == "True":
    ...
    if os.environ.get("READTHEDOCS_VERSION_TYPE") == "external":
        ...
        readthedocs_vcs_url = "http://github.com/aignas/pytest-bazel/pull/{}".format(
        ...
        _build_id = os.environ.get("HOSTNAME", "build-0-project-0-pytest-bazel")
        _build_id = _build_id.split("-")[1]
        readthedocs_build_url = (
            f"https://readthedocs.org/projects/pytest-bazel/builds/{_build_id}"
        )
...
extlinks = {
    "gh-path": ("https://github.com/aignas/pytest-bazel/tree/main/%s", "%s"),
}
